  ...
  getStyleDeclarations: function (node) {
    if (
      ...
      if (arg.type === 'ObjectExpression' && arg.properties) {
        return arg.properties.filter((property) => property.type === 'Property');
      }
      if (arg.type === 'ArrowFunctionExpression' || arg.type === 'FunctionExpression') {
        if (arg.body.type === 'ObjectExpression') {
          return arg.body.properties.filter((property) => property.type === 'Property');
        }
        if (arg.body.type === 'BlockStatement') {
          const returnStatement = arg.body.body.find((stmt) => stmt.type === 'ReturnStatement');
          if (returnStatement && returnStatement.argument.type === 'ObjectExpression') {
            return returnStatement.argument.properties.filter((property) => property.type === 'Property');
          }
        }
      }
    }
